...
The AI assistant will guide you through the entire setup process in about 5-10 minutes. For experienced users, use `QUICK_SETUP_PROMPT.md` instead.
...
The assistant will handle most of the setup automatically. For experienced users, reference `QUICK_SETUP_PROMPT.md` instead.
