...
For the easiest setup experience, use your AI coding assistant! We provide setup prompts that will guide you through the entire process:

- **[Full Guided Setup](SETUP_ASSISTANT_PROMPT.md)** - Comprehensive step-by-step guidance with explanations
- **[Quick Setup](QUICK_SETUP_PROMPT.md)** - Condensed version for experienced users

Simply copy one of these prompts to your AI coding assistant (Claude Code, Cursor, etc.) and it will help you complete the setup.
